...
public class TopsRecyclerAdapter extends RecyclerView.Adapter<TopsRecyclerAdapter.myHolders> {
    List<Garment> list;
    Context context;
    View view;

    public TopsRecyclerAdapter(List<Garment> list, Context context) {
        this.list = list;
